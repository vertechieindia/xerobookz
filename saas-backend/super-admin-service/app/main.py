"""Super Admin Service - XeroBookz Admin Team Management"""
...
app = FastAPI(
    title="XeroBookz Super Admin Service",
    version="1.0.0",
    description="Super Admin service for managing companies, statistics, dashboards, and API keys",
    lifespan=lifespan,
)
